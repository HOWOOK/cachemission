...
import com.selectstar.hwshin.cashmission.Adapter.NoticetviewAdapter;
...
public class NoticeActivity extends AppCompatActivity {
    ...
    ListView listView;
    static NoticetviewAdapter adapter;
                ...
                protected void onPostExecute(Object o) {
                    ...
                    try {
                        ...
                        if(res.get("success").toString().equals(("true")))
                        {
                            ...
                            adapter = new NoticetviewAdapter(getApplicationContext(), R.layout.notice_lv, NoticeActivity.mNoticeList);
