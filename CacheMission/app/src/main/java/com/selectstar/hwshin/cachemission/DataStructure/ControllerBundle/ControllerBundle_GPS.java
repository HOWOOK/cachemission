package com.selectstar.hwshin.cachemission.DataStructure.ControllerBundle;
 ...
 */
public class ControllerBundle_GPS extends Service implements LocationListener {
    ...
    public ControllerBundle_GPS(Context context, Handler handler) {
    ...
    public void stopUsingGPS(){
        ...
        if(locationManager != null){
            locationManager.removeUpdates(ControllerBundle_GPS.this);
        }
    }
